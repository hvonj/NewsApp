...
namespace NewsApp.Controllers
{
    ...
    public class NewsController : Controller
    {
        ...
        [HttpGet("")] //samma sak som att inte skriva något alls. Då anropar man genom att skriva ...api/news 
        ...
        [HttpGet("{id}")] //GET om man vill hämta en specifik ID ...api/news/5 --> för att hämta API5
        ...
        [HttpPost]
        public IActionResult Add([FromBody]News news) //skapa en ny class för att adda en nyhet
        {
            if (news == null)
            {
